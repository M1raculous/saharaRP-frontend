...
?>
    ...
    <body id="body">
        ...
        <h1 class="player_information_header">Server Information</h1>
        <p class="player_information_text">Kort beskrivelse.....</p>
            <div id="btnContainer">
  <button class="btn" onclick="listView()"><i class="fa fa-bars"></i> List</button> 
  <button class="btn active" onclick="gridView()"><i class="fa fa-th-large"></i> Grid</button>
</div>
<br>
<div id="server-information" class="dashboard_box_serverinformation">
    ...
    <script src="../assets/js/server-information.js"></script>
</html>